...
with open('rap-names.txt', 'r') as dataFile:
    ...
    for name in dataFile:
        # COMMENT THIS CODE:strips off the invsibile line at the end of each line and appends text to possible_names list
...
for i in range(count):
    # COMMENT THIS CODE:empty list to store input data
    name_parts = []
    ...
    for j in range(parts):
        ...
        # Snippet 7
        # == == == == == == == == == == == == == == == ==
        # COMMENT THIS CODE:joins the elements of the name parts list and turns them into a string
